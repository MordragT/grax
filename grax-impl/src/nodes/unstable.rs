...
impl<V: Debug> FixedNodeMap<usize, V> for UnstableNodeVec<V> {}
...
impl<V: Debug> NodeMap<usize, V> for UnstableNodeVec<V> {}
...
impl<V: Debug> NodeStorage<usize, V> for UnstableNodeVec<V> {
